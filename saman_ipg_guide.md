...
> [!WARNING]
> **انتقال از طریق پیوند (Referrer):** هدایت کاربر حتماً باید از طریق سابمیت فرم یا لینک کلیک شده در دامنه پذیرنده انجام شود تا مرورگر مقدار `Referrer` معتبر ارسال کند؛ در غیر این صورت درگاه خطا خواهد داد.
